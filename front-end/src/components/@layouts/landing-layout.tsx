          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
                <Button className="bg-green-500 text-white hover:bg-green-600 rounded-full px-8 py-3 text-lg font-bold" onClick={handleDonateClick}>Donate Now</Button>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white rounded-lg">
          ...
          <form onSubmit={sendOneWei}>
            <div className="grid gap-4 py-4">
              ...
              {/* <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="wallet-id" className="text-right text-blue-800">
                  Wallet ID
                </Label>
                <Input
                  id="wallet-id"
